...
func NewPetstoreServiceProtobufClient(addr string, client HTTPClient) PetstoreService {
	prefix := urlBase(addr) + PetstoreServicePathPrefix
	urls := [5]string{
		prefix + "AddPet",
		prefix + "DeletePet",
		prefix + "FindPetById",
		prefix + "FindPets",
		prefix + "FindPetsByIds",
	}
...
func (c *petstoreServiceProtobufClient) AddPet(ctx context.Context, in *AddPetRequest) (*AddPetResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "am.is")
	ctx = ctxsetters.WithServiceName(ctx, "PetstoreService")
	ctx = ctxsetters.WithMethodName(ctx, "AddPet")
...
func (c *petstoreServiceProtobufClient) FindPetById(ctx context.Context, in *FindPetByIdRequest) (*FindPetByIdResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "am.is")
	ctx = ctxsetters.WithServiceName(ctx, "PetstoreService")
	ctx = ctxsetters.WithMethodName(ctx, "FindPetById")
...
func (c *petstoreServiceProtobufClient) FindPets(ctx context.Context, in *FindPetsRequest) (*FindPetsResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "am.is")
	ctx = ctxsetters.WithServiceName(ctx, "PetstoreService")
	ctx = ctxsetters.WithMethodName(ctx, "FindPets")
...
func (c *petstoreServiceProtobufClient) FindPetsByIds(ctx context.Context, in *FindPetsByIdsRequest) (*FindPetsByIdsResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "am.is")
	ctx = ctxsetters.WithServiceName(ctx, "PetstoreService")
	ctx = ctxsetters.WithMethodName(ctx, "FindPetsByIds")
...
func (c *petstoreServiceJSONClient) AddPet(ctx context.Context, in *AddPetRequest) (*AddPetResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "am.is")
	ctx = ctxsetters.WithServiceName(ctx, "PetstoreService")
	ctx = ctxsetters.WithMethodName(ctx, "AddPet")
	out := new(AddPetResponse)
...
func (c *petstoreServiceJSONClient) FindPetById(ctx context.Context, in *FindPetByIdRequest) (*FindPetByIdResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "am.is")
	ctx = ctxsetters.WithServiceName(ctx, "PetstoreService")
	ctx = ctxsetters.WithMethodName(ctx, "FindPetById")
	out := new(FindPetByIdResponse)
...
func (c *petstoreServiceJSONClient) FindPets(ctx context.Context, in *FindPetsRequest) (*FindPetsResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "am.is")
	ctx = ctxsetters.WithServiceName(ctx, "PetstoreService")
	ctx = ctxsetters.WithMethodName(ctx, "FindPets")
	out := new(FindPetsResponse)
...
func (c *petstoreServiceJSONClient) FindPetsByIds(ctx context.Context, in *FindPetsByIdsRequest) (*FindPetsByIdsResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "am.is")
	ctx = ctxsetters.WithServiceName(ctx, "PetstoreService")
	ctx = ctxsetters.WithMethodName(ctx, "FindPetsByIds")
	out := new(FindPetsByIdsResponse)
...
// PetstoreServicePathPrefix is used for all URL paths on a twirp PetstoreService server.
// Requests are always: POST PetstoreServicePathPrefix/method
...
func (s *petstoreServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/am.is.PetstoreService/AddPet":
		s.serveAddPet(ctx, resp, req)
		return
	case "/twirp/am.is.PetstoreService/DeletePet":
		s.serveDeletePet(ctx, resp, req)
		return
	case "/twirp/am.is.PetstoreService/FindPetById":
		s.serveFindPetById(ctx, resp, req)
		return
	case "/twirp/am.is.PetstoreService/FindPets":
		s.serveFindPets(ctx, resp, req)
		return
	case "/twirp/am.is.PetstoreService/FindPetsByIds":
		s.serveFindPetsByIds(ctx, resp, req)
		return
	default:
...
func (s *petstoreServiceServer) serveAddPet(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveAddPetJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveAddPetProtobuf(ctx, resp, req)
	default:
...
func (s *petstoreServiceServer) serveAddPetJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "AddPet")
	...
	// Call service method
	var respContent *AddPetResponse
	func() {
		defer func() {
		...
		respContent, err = s.PetstoreService.AddPet(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *AddPetResponse and nil error while calling AddPet. nil responses are not supported"))
		return
	}
...
func (s *petstoreServiceServer) serveAddPetProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "AddPet")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *petstoreServiceServer) serveDeletePetJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	func() {
		...
		respContent, err = s.PetstoreService.DeletePet(ctx, reqContent)
	}()
...
func (s *petstoreServiceServer) serveFindPetById(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveFindPetByIdJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveFindPetByIdProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *petstoreServiceServer) serveFindPetByIdJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "FindPetById")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(FindPetByIdRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		err = wrapErr(err, "failed to parse request json")
		s.writeError(ctx, resp, twirp.InternalErrorWith(err))
	...
	// Call service method
	var respContent *FindPetByIdResponse
	func() {
		defer func() {
			// In case of a panic, serve a 500 error and then panic.
			if r := recover(); r != nil {
		...
		respContent, err = s.PetstoreService.FindPetById(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *FindPetByIdResponse and nil error while calling FindPetById. nil responses are not supported"))
		return
	}
...
func (s *petstoreServiceServer) serveFindPetByIdProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "FindPetById")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *petstoreServiceServer) serveFindPets(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveFindPetsJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveFindPetsProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *petstoreServiceServer) serveFindPetsJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "FindPets")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(FindPetsRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		err = wrapErr(err, "failed to parse request json")
		s.writeError(ctx, resp, twirp.InternalErrorWith(err))
	...
	// Call service method
	var respContent *FindPetsResponse
	func() {
		defer func() {
			// In case of a panic, serve a 500 error and then panic.
			if r := recover(); r != nil {
		...
		respContent, err = s.PetstoreService.FindPets(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *FindPetsResponse and nil error while calling FindPets. nil responses are not supported"))
		return
	}
...
func (s *petstoreServiceServer) serveFindPetsProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "FindPets")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *petstoreServiceServer) serveFindPetsByIds(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveFindPetsByIdsJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveFindPetsByIdsProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *petstoreServiceServer) serveFindPetsByIdsJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "FindPetsByIds")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(FindPetsByIdsRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		err = wrapErr(err, "failed to parse request json")
		s.writeError(ctx, resp, twirp.InternalErrorWith(err))
	...
	// Call service method
	var respContent *FindPetsByIdsResponse
	func() {
		defer func() {
			// In case of a panic, serve a 500 error and then panic.
			if r := recover(); r != nil {
		...
		respContent, err = s.PetstoreService.FindPetsByIds(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *FindPetsByIdsResponse and nil error while calling FindPetsByIds. nil responses are not supported"))
		return
	}
...
func (s *petstoreServiceServer) serveFindPetsByIdsProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "FindPetsByIds")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
